...
general {
    ...
    gaps_out = 5
    border_size = 1
    col.active_border = rgba(f8f7f2ee) rgba(aaaaaaee) 45deg
...
bind = $mainMod, M, exec, rofi-power-menu -dmenu -i -l 4
bind = $mainMod, E, exec, kitty mc
bind = $mainMod, V, togglefloating,
bind = $mainMod, R, exec, rofi -terminal kitty -show-icons -show drun
...
bindm = ALT_L, mouse:272, resizewindow
...
windowrulev2 = fullscreen,class:(GLava)
...
windowrulev2 = opacity 1.0,class:(GLava)
''
